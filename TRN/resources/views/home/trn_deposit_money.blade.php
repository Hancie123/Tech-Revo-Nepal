...
@push('title')
<title>TRN Finance System | Deposit Money</title>
    ...
    <main id="main" class="main">
        ...
        <div class="card">
            ...
            <div class="text-center">
                <h2 id="heading" class="card-title p-0 m-0 text-light p-3 bg-success">TRN Finance System | Deposit Money
                </h2>
            </div>
            <br>


            <form action="{{url('/home/trn_finance_system/deposit_money')}}" method="post">
