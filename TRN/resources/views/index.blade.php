    ...
    <div class="container position-relative">
      <div class="row gy-5" data-aos="fade-in">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center text-center text-lg-start">
          ...
          <p>An excellent IT company to work with for creating Android applications. desktop applications as well as web applications.</p>
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="100">
            <div class="member">
              ...
              <div class="social">
                <a href="https://twitter.com/hancie_phago" target="_blank"><i class="bi bi-twitter"></i></a>
                <a href="https://www.facebook.com/hanciephago720/" target="_blank"><i class="bi bi-facebook"></i></a>
